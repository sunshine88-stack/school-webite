<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($message)) {
            $feedback1 = "Your message is required";
        }
        ...
        $sql = "INSERT INTO tblcomplain (studentName, message) 
            VALUES ('$name', '$message')";
...
<body>
    ...
    <div id="form-container">
        <center><h1>Make a Complaints</h1></center>
        <form id="login-form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <textarea name="message" id="message" rows="15" placeholder="enter message here" ></textarea>
